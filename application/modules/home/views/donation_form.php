					   ...
					   <div class="information_area contact_form">
					   	<div class="row">
					   		<div class="col-lg-12 pt-4 pb-4">
					   			...
					   			<input type="hidden" name="location" value="<?php echo base_url(); ?>donation_form">
					   		</div>	
					   		<div class="col-md-6">
					   			<div class="form-group">
					   		...
					   		<div class="col-md-6">
					   			<div class="form-group">
					   				<select class="form-control" id="purpose" name="purpose" required>
					   					...
					   					<option value="Donation Gift" <?php if($this->session->flashdata('purpose') == "Donation Gift"){ ?> selected <?php } ?>> Donation Gift </option>
					   				</select>
					   			</div>
					   		</div>
					   		<div class="col-md-6">
